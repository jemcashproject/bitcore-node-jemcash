...
/**
 * Will return the path and default bitcore-node-jemcash configuration. It will search for the
...
function getDefaultConfig(options) {
    ...
    var defaultConfigFile = path.join(defaultPath, 'bin/bitcore-node-jemcash.json');
            ...
            servicesConfig: {
                bitcoind: {
                    spawn: {
                        ...
                        exec: path.join(defaultPath, './bin/jemcashd')
                    }
                }
            }
        };
