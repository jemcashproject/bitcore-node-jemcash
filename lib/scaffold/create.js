...
var BASE_PACKAGE = {
    description: 'A full Jemcash node build with Bitcore',
    repository: 'https://github.com/jemcashproject/bitcore-node-jemcash',
    license: 'MIT',
    readme: 'README.md',
    dependencies: {
        'jcore-lib': 'git://github.com/jemcashproject/jcore-lib.git',
        'bitcore-node-jemcash': 'git://github.com/jemcashproject/bitcore-node-jemcash.git',
        //'insight-ui-jemcash': 'git://github.com/jemcashproject/insight-ui-jemcash.git',
        //'insight-api-jemcash': 'git://github.com/jemcashproject/insight-api-jemcash.git'
    }
};
...
/**
 ...
 'jcore-lib': '^' + bitcore.version,
 'bitcore-node-jemcash': version
...
function createConfigDirectory(options, configDir, isGlobal, done) {
    mkdirp(configDir, function (err) {
        ...
        try {
            fs.writeFileSync(configDir + '/bitcore-node-jemcash.json', configJSON);
            if (!isGlobal) {
...
function create(options, done) {
    ...
    async.series([
        function (next) {
            // Setup the the bitcore-node-jemcash directory and configuration
