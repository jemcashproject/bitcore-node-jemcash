...
function main(servicesPath, additionalServices) {
    ...
    program
        ...
        .option('-d, --daemon', 'Make bitcore-node-jemcash a daemon (running in the background)')
        .action(function (cmd) {
            if (cmd.config) {
    ...
    program
        ...
        .action(function (services) {
            ...
            if (!configInfo) {
                throw new Error('Could not find configuration, see `bitcore-node-jemcash create --help`');
            }
            var opts = {
        ...
        console.log();
        console.log('    $ bitcore-node-jemcash add wallet-service');
        console.log('    $ bitcore-node-jemcash add insight-api');
        console.log();
    });
    ...
    program
        ...
        console.log('  Examples:');
        console.log();
        console.log('    $ bitcore-node-jemcash remove wallet-service');
        console.log('    $ bitcore-node-jemcash remove insight-api');
        console.log();
    });
