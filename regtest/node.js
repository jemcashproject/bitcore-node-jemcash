...
var testWIF = AddrUtils.bitcoin_address_to_jemcash('cSdkPxkAjA4HDr5VHgsebAPDEh9Gyub4HK8UJr2DFGGqKKy4K5sG');
var testKey;
var client;
                ...
                services: [
                    {
                        ...
                        config: {
                            spawn: {
                                datadir: datadir,
                                //exec: path.resolve(__dirname, './.bitcore/data/jemcashd')
