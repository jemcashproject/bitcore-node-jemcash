...
describe('Bitcoin Cluster', function () {
    var node;
    var daemons = [];
    //var execPath = path.resolve(__dirname, './.bitcore/data/jemcashd');
    var execPath = path.resolve(__dirname, '../bin/jemcashd');
    // + changes  of bitcoin.conf to jemcash.conf
    var nodesConf = [
        {
            datadir: path.resolve(__dirname, './data/node1'),
            conf: path.resolve(__dirname, './data/node1/jemcash.conf'),
            rpcuser: 'bitcoin',
        ...
        },
        {
            ...
            conf: path.resolve(__dirname, './data/node2/jemcash.conf'),
            rpcuser: 'bitcoin',
            rpcpassword: 'local321',
            rpcport: 30522,
        ...
        },
        {
            ...
            conf: path.resolve(__dirname, './data/node3/jemcash.conf'),
            rpcuser: 'bitcoin',
            rpcpassword: 'local321',
            rpcport: 30523,
    ...
    before(function (done) {
        log.info('Starting 3 jemcashd daemons');
        this.timeout(60000);
