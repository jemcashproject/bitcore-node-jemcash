...
describe('#defaultConfig', function() {
  var expectedExecPath = path_module.resolve(__dirname, '../../bin/jemcashd');
  //var expectedExecPath = path.resolve(__dirname, './.bitcore/data/jemcashd');
    ...
    var defaultConfig = proxyquire('../../lib/scaffold/default-config', {
      fs: {
        ...
        writeFileSync: function(path, data) {
          path.should.equal(path_module.join(process.cwd(), 'bin/bitcore-node-jemcash.json'));
