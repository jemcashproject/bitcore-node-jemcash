...
describe('Bitcoin Service', function() {
  ...
  describe('#subscribeAddress', function() {
    ...
    it('will add a valid address', function() {
      var bitcoind = new BitcoinService(baseConfig);
      var emitter = new EventEmitter();
      bitcoind.subscribeAddress(emitter, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      should.exist(bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
    });
    it('will handle multiple address subscribers', function() {
      var bitcoind = new BitcoinService(baseConfig);
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      bitcoind.subscribeAddress(emitter1, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      bitcoind.subscribeAddress(emitter2, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      should.exist(bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(2);
    });
    it('will not add the same emitter twice', function() {
      ...
      bitcoind.subscribeAddress(emitter1, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      should.exist(bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddress', function() {
    ...
    it('it will remove a subscription', function() {
      ...
      should.exist(bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(2);
      bitcoind.unsubscribeAddress(emitter1, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(1);
    });
    it('will unsubscribe subscriptions for an emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')] = [emitter1, emitter2];
    ...
    it('will NOT unsubscribe subscription with missing address', function() {
      ...
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')] = [emitter1, emitter2];
      bitcoind.unsubscribeAddress(emitter1, [AddrUtils.bitcoin_address_to_jemcash('1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo')]);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(2);
    });
    it('will NOT unsubscribe subscription with missing emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')] = [emitter2];
      bitcoind.unsubscribeAddress(emitter1, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(1);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')][0].should.equal(emitter2);
    });
    it('will remove empty addresses', function() {
      ...
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')] = [emitter1, emitter2];
      bitcoind.unsubscribeAddress(emitter1, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      bitcoind.unsubscribeAddress(emitter2, [AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
      should.not.exist(bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')]);
    });
    it('will unsubscribe emitter for all addresses', function() {
      ...
      var emitter2 = new EventEmitter();
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')] = [emitter1, emitter2];
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo')] = [emitter1, emitter2];
      sinon.spy(bitcoind, 'unsubscribeAddressAll');
      bitcoind.unsubscribeAddress(emitter1);
      bitcoind.unsubscribeAddressAll.callCount.should.equal(1);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(1);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo')].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddressAll', function() {
    ...
    it('will unsubscribe emitter for all addresses', function() {
      ...
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('3CMNFxN1oHBc4R1EpboAL5yzHGgE611Xou')] = [emitter1];
      bitcoind.unsubscribeAddress(emitter1);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br')].length.should.equal(1);
      bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo')].length.should.equal(1);
      bitcoind.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'].length.should.equal(1);
      should.not.exist(bitcoind.subscriptions.address[AddrUtils.bitcoin_address_to_jemcash('3CMNFxN1oHBc4R1EpboAL5yzHGgE611Xou')]);
    });
  });
  ...
  describe('#_getNetworkConfigPath', function() {
    ...
    it('will get default rpc port for testnet', function() {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('testnet3/jemcash.conf');
    });
    it('will get default rpc port for regtest', function() {
      bitcore.Networks.enableRegtest();
      var config = {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('regtest/jemcash.conf');
    });
  });
  ...
  describe('#_getAddressesFromTransaction', function() {
    it('will get results using bitcore.Transaction', function() {
      var bitcoind = new BitcoinService(baseConfig);
      var wif = AddrUtils.bitcoin_address_to_jemcash('L2Gkw3kKJ6N24QcDuH4XDqt9cTqsKTVNDGz1CRZhk9cq4auDUbJy');
      var privkey = bitcore.PrivateKey.fromWIF(wif);
      var inputAddress = privkey.toAddress(bitcore.Networks.testnet);
      var outputAddress = bitcore.Address(AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'));
    ...
    it('will return unique values', function() {
      var bitcoind = new BitcoinService(baseConfig);
      var tx = bitcore.Transaction();
      var address = bitcore.Address(AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'));
      tx.addOutput(bitcore.Transaction.Output({
  ...
  describe('#_notifyAddressTxidSubscribers', function() {
    it('will emit event if matching addresses', function(done) {
      var bitcoind = new BitcoinService(baseConfig);
      var address = AddrUtils.bitcoin_address_to_jemcash(AddrUtils.bitcoin_address_to_jemcash('1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo'));
  ...
  describe('#getAddressBalance', function() {
    it('will give rpc error', function(done) {
      ...
      var address = AddrUtils.bitcoin_address_to_jemcash('1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo');
      var options = {};
  ...
  describe('#getAddressUnspentOutputs', function() {
    ...
    it('will give results from client getaddressutxos', function(done) {
      ...
      var expectedUtxos = [
        {
          address: AddrUtils.bitcoin_address_to_jemcash('1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo'),
  ...
  describe('#_getAddressStrings', function() {
    it('will get address strings from bitcore addresses', function() {
      var addresses = [
        bitcore.Address(AddrUtils.bitcoin_address_to_jemcash('1AGNa15ZQXAZUgFiqJ2i7Z2DPU2J6hW62i')),
        bitcore.Address(AddrUtils.bitcoin_address_to_jemcash('3CMNFxN1oHBc4R1EpboAL5yzHGgE611Xou')),
      ];
      var bitcoind = new BitcoinService(baseConfig);
      var strings = bitcoind._getAddressStrings(addresses);
      strings[0].should.equal(AddrUtils.bitcoin_address_to_jemcash('1AGNa15ZQXAZUgFiqJ2i7Z2DPU2J6hW62i'));
      strings[1].should.equal(AddrUtils.bitcoin_address_to_jemcash('3CMNFxN1oHBc4R1EpboAL5yzHGgE611Xou'));
    });
    it('will get address strings from strings', function() {
      var addresses = [
        AddrUtils.bitcoin_address_to_jemcash('1AGNa15ZQXAZUgFiqJ2i7Z2DPU2J6hW62i'),
        AddrUtils.bitcoin_address_to_jemcash('3CMNFxN1oHBc4R1EpboAL5yzHGgE611Xou'),
      ];
      var bitcoind = new BitcoinService(baseConfig);
      var strings = bitcoind._getAddressStrings(addresses);
      strings[0].should.equal(AddrUtils.bitcoin_address_to_jemcash('1AGNa15ZQXAZUgFiqJ2i7Z2DPU2J6hW62i'));
  ...
  describe('#_maybeGetBlockHash', function() {
    it('will not get block hash with an address', function(done) {
      ...
      bitcoind._maybeGetBlockHash(AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'), function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
        hash.should.equal(AddrUtils.bitcoin_address_to_jemcash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'));
        done();
      });
    });
